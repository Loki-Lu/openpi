...
export HF_LEROBOT_HOME=/gemini/space/users/tong/data/cube_sponge/lerobot_100
export OPENPI_DATA_HOME=/gemini/space/users/tong/models/jaxpi
CUDA_VISIBLE_DEVICES=0 \
XLA_PYTHON_CLIENT_MEM_FRACTION=0.9 \
TENSORSTORE_CONTEXT='{"file_io_locking": false}' \
uv run ../scripts/train.py pi0_umi_cube_sponge_100 --exp-name=pi0_umi_cube_sponge_100 --overwrite --batch_size=40 --num_train_steps=300_000
