...
export HF_LEROBOT_HOME=/gemini-1/space/tong/data/lerobot_jnt
export OPENPI_DATA_HOME=/gemini-1/space/tong/models/jaxpi
CUDA_VISIBLE_DEVICES=0 \
XLA_PYTHON_CLIENT_MEM_FRACTION=0.9 \
TENSORSTORE_CONTEXT='{"file_io_locking": false}' \
uv run ../scripts/train.py pi0_umi_cube_sponge_jnt_delta --exp-name=pi0_umi_cube_sponge_jnt_delta --overwrite --batch_size=40 --num_train_steps=300_000
