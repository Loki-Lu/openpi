...
if __name__ == "__main__":
    ROOT = "/gemini-1/space/tong/data/cube_sponge"
    
    # 在这里直接指定你想要的 FPS
    convert_all_parallel(
        ROOT,
        target_fps=30, 
        max_workers=min(40, os.cpu_count()),
    )